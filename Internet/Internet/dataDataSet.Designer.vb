...
Partial Public Class dataDataSet
    ...
    Partial Public Class ClientesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddClientesRow(ByVal DPI As String, ByVal Nombre As String, ByVal Telefono As String, ByVal Direccion As String) As ClientesRow
            Dim rowClientesRow As ClientesRow = CType(Me.NewRow,ClientesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, DPI, Nombre, Telefono, Direccion}
...
Namespace dataDataSetTableAdapters
    ...
    Partial Public Class ClientesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Clientes` WHERE ((`Id` = ?) AND ((? = 1 AND `DPI` IS NULL) OR (`DPI`"& _ 
                " = ?)) AND ((? = 1 AND `Nombre` IS NULL) OR (`Nombre` = ?)) AND ((? = 1 AND `Tel"& _ 
                "efono` IS NULL) OR (`Telefono` = ?)) AND ((? = 1 AND `Direccion` IS NULL) OR (`D"& _ 
                "ireccion` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Clientes` (`DPI`, `Nombre`, `Telefono`, `Direccion`) VALUES (?, ?, ?"& _ 
                ", ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Clientes` SET `DPI` = ?, `Nombre` = ?, `Telefono` = ?, `Direccion` = ? WH"& _ 
                "ERE ((`Id` = ?) AND ((? = 1 AND `DPI` IS NULL) OR (`DPI` = ?)) AND ((? = 1 AND `"& _ 
                "Nombre` IS NULL) OR (`Nombre` = ?)) AND ((? = 1 AND `Telefono` IS NULL) OR (`Tel"& _ 
                "efono` = ?)) AND ((? = 1 AND `Direccion` IS NULL) OR (`Direccion` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Internet.My.MySettings.Default.dataConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, DPI, Nombre, Telefono, Direccion FROM Clientes"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As dataDataSet.ClientesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As dataDataSet.ClientesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As dataDataSet.ClientesDataTable = New dataDataSet.ClientesDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As dataDataSet.ClientesDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_DPI As String, ByVal Original_Nombre As String, ByVal Original_Telefono As String, ByVal Original_Direccion As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal DPI As String, ByVal Nombre As String, ByVal Telefono As String, ByVal Direccion As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal DPI As String, ByVal Nombre As String, ByVal Telefono As String, ByVal Direccion As String, ByVal Original_Id As Integer, ByVal Original_DPI As String, ByVal Original_Nombre As String, ByVal Original_Telefono As String, ByVal Original_Direccion As String) As Integer
            If (DPI Is Nothing) Then
